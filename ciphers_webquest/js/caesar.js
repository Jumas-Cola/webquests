window.addEventListener('DOMContentLoaded', function() {
    ...
    var UserText = document.getElementById('caesar-source');
    var UserSelectStap = document.getElementById('caesar-offset');
    var UserStep = Number(UserSelectStap.value);
    var result = document.getElementById('caesar-result');
    var Encrypt = document.getElementById('text2caesar');
    var Decrypt = document.getElementById('caesar2text');
    ...
    Decrypt.addEventListener('click', function() {
        TextToWork = result.value;
        UserText.value = decrypt(TextToWork);
    });
